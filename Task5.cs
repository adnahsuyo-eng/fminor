...
public class Task5
{
    ...
    {
        Console.WriteLine("********************************");
        Console.WriteLine("Student's Report Card");
        Console.WriteLine("********************************");
        ...
        if (!string.IsNullOrEmpty(input) && int.TryParse(input, out numberOfStudents))
        {
            ...
            for (int i = 0; i < numberOfStudents; i++)
            {
                ...
                Console.WriteLine($"Enter English grades for {students[i].Name} out of 100:");
                students[i].English = int.Parse(Console.ReadLine() ?? "0");
                Console.WriteLine($"Enter Math grades for {students[i].Name} out of 100:");
                students[i].Math = int.Parse(Console.ReadLine() ?? "0");
                Console.WriteLine($"Enter Computer grades for {students[i].Name} out of 100:");
